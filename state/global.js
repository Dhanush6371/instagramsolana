...
//creaing user
  ...
  try {
    ...
    const txHash = await program.methods.createUser().accounts({ user: userAccountPk, owner }).rpc();
    await connection.confirmTransaction(txHash);
...
}, [program, wallet, connection, airdrop, getUserAccountPk, fetchUserAccount, toast]);
